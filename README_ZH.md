...
- [waifu2x](http://waifu2x.udp.jp/index.tr.html)：用于动漫风格艺术的单图像超分辨率深度卷积神经网络。它也支持照片。![repo](https://github.com/nagadomi/waifu2x) ![mit](https://github.com/nagadomi/waifu2x/blob/master/LICENSE)
- [Let'sEnhance.io](https://letsenhance.io/)：提高图像质量和分辨率。我们的AI基础编辑过程自动增强您图像中的任何缺陷。
- [Dain-App](https://grisk.itch.io/dain-app)：[Dain](https://github.com/baowenbo/DAIN)-App是一个免费的应用，让您可以对任何形式的媒体进行处理，如电影、定格动画、动漫、卡通、精灵等，并插值新帧，从原始文件生成更大的帧率。![mit](https://github.com/baowenbo/DAIN)
- [3D Photo Inpainting](https://shihmengli.github.io/3D-Photo-Inpainting/)：3D摄影使用上下文感知层深度绘制。![repo](https://github.com/vt-vl-lab/3d-photo-inpainting) ![mit](https://github.com/vt-vl-lab/3d-photo-inpainting/blob/master/LICENSE)
- [Infinite Nature](https://infinite-nature.github.io/)：从单张图像生成自然场景的永久视图。![repo](https://github.com/google-research/google-research/tree/master/infinite_nature)
- [PaintsChainer](https://paintschainer.preferred.tech/index_en.html)：AI驱动的自动线绘制着色。![repo](https://github.com/pfnet/PaintsChainer) ![mit](https://github.com/pfnet/PaintsChainer/blob/master/LICENSE)
- [EbSynth](https://ebsynth.com/)：免费工具，将视频镜头转换为风格化的运动绘画。
- [PIFuHD](https://shunsukesaito.github.io/PIFuHD/)：高分辨率3D人体数字化的多级像素对齐隐式函数。![repo](https://github.com/facebookresearch/pifuhd)
- [Generated.Photos](https://generated.photos/faces)：AI生成的面孔。
- [Flowframes](https://nmkd.itch.io/flowframes)：是一个简单但强大的应用，利用AI框架插值视频，以增加帧率，几乎不会造成可察觉的质量损失。![repo](https://github.com/n00mkrad/flowframes)
- [Cupscale](https://github.com/n00mkrad/cupscale)：基于ESRGAN的图像上采样GUI。
- [Video2X](https://video2x.org/)：无损视频/GIF/图像上采样器，通过waifu2x、Anime4K、SRMD和RealSR实现。![repo](https://github.com/k4yt3x/video2x) ![gpl](https://github.com/k4yt3x/video2x/blob/master/LICENSE)
- [koi](https://github.com/nousr/koi)：Krita的插件，启用AI模型进行img2img生成。
- [Real-ESRGAN](https://github.com/xinntao/Real-ESRGAN)：旨在开发实用的算法，用于通用图像/视频恢复。
- [Midjourney](https://www.midjourney.com/home/)：是一个独立的研究实验室，生产专有的人工智能程序，从文本描述中创造图像。
- [Stable Diffusion](https://stability.ai/blog/stable-diffusion-public-release)：是一个潜在的文本到图像扩散模型，能够根据任何文本输入生成逼真的图像。
- [Deforum Stable Diffusion](https://replicate.com/deforum/deforum_stable_diffusion)：用Stable Diffusion制作动画提示。
...
欢迎您的贡献！^_^ 如果您想为这个列表做贡献，请发送一个_pull request_，打开一个_issue_或联系我@agmmnn。请先阅读_[贡献指南](https://github.com/agmmnn/awesome-blender/blob/master/CONTRIBUTING.md)_，一些部分有它们自己的指南作为注释行。
